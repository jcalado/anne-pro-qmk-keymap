...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
      ...
      _______, PT_LABK, S(PT_LABK), XXXXXXX, XXXXXXX, TG(3),XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_DEL,                    _______,
      _______, _______, _______,                   XXXXXXX,                                     _______, _______, _______, _______
  ),
  [2] = LAYOUT(
      RESET,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX,
